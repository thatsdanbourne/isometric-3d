...
public static class PlaceableItems
{
	public static void Register()
	{
		ItemRegistry.RegisterItem(new PlaceableItem
		{
			...
			StackSize = 1,
			PlaceableObjectTypeId = DeterministicHash.String32("campfire"),
		...
		ItemRegistry.RegisterItem(new PlaceableItem
		{
			...
			StackSize = 1,
			PlaceableObjectTypeId = DeterministicHash.String32("crafting_table"),
		...
		ItemRegistry.RegisterItem(new PlaceableItem
		{
			...
			Icon = LoadIcon("kiln"),
			StackSize = 1,
			PlaceableObjectTypeId = DeterministicHash.String32("kiln"),
		...
		ItemRegistry.RegisterItem(new PlaceableItem
		{
			...
			StackSize = 1,
			PlaceableObjectTypeId = DeterministicHash.String32("chest"),
